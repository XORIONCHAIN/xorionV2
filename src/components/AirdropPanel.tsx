  ...
  return (
    <div className="max-w-xl mx-auto shadow-2xl rounded-2xl flex flex-col bg-gradient-to-br from-[#2e2257] via-[#1e284b] to-[#ff9100]/30 p-6 mt-12 items-stretch">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h2 className="text-2xl font-bold text-[#f0e6ff] tracking-tight">
          Airdrop Claim Panel
        </h2>
      </div>
      {status === "error" && (
      ...
      {/* Account Selection */}
      <label className="text-sm text-purple-200 mb-2 font-semibold">
        Account
      </label>
      ...
      <div className="flex items-center justify-center mb-6">
        ...
        <span className="text-[#f6d9ff] drop-shadow font-semibold">
          No eligibility check. Click claim and receive instantly.
        </span>
      </div>
      <button
